    ...
    <div className="min-h-screen bg-black text-white px-6 py-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-400 mb-12">
          Explore all features built to protect your wallet & track the market.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((tool, idx) => (
            <div
              key={idx}
              className="bg-gray-900 border border-purple-600 rounded-xl p-6 text-left shadow-md hover:scale-[1.02] hover:shadow-purple-500/30 transition-all duration-200"
            >
